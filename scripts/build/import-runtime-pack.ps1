...
if ($provenance.sourceRevision -cne $profile.revision -or $provenance.runtimeVersion -cne $profile.version -or
...
try {
    ...
    Test-RuntimeProfilePack -Root $staging -Profile $profile
